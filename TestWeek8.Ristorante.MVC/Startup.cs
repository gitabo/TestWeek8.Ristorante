...
using TestWeek8.Ristorante.Core;
using TestWeek8.Ristorante.Core.Interfaces;
using TestWeek8.Ristorante.EF;
using TestWeek8.Ristorante.EF.Repositories;

namespace TestWeek8.Ristorante.MVC
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration.GetConnectionString("RistoranteDB"));
            });
            ...
            services.AddAuthorization(
                options =>
                {
                    options.AddPolicy("RestaurantUser", policy => policy.RequireRole("Ristoratore"));
